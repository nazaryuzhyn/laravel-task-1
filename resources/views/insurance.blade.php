...
@section('title')PobytOK - Страхование@endsection

@section('content')
    <main>
        <section class="notice-greetings typical-page--main typical-page-insurance">
            <div class="container">
                <div>
                ...
                <div class="head__info head__info--left">
                    <div>
                        <p class="head__info__count" data-value="34324">34 324</p>
                        <p class="head__info__desc">воспользовались предложением</p>
                    </div>
                    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="22" cy="22" r="22" fill="#FF9066" />
                        <path d="M26.8347 16.5834C26.8347 19.1147 24.7827 21.1666 22.2514 21.1666C19.7201 21.1666 17.668 19.1147 17.668 16.5834C17.668 14.0521 19.7201 12 22.2514 12C24.7827 12 26.8347 14.0521 26.8347 16.5834Z" fill="#F2F2F2" />
                ...
                <div class="head__info head__info--bottom">
                    <div>
                        <p class="head__info__count" data-value="1100">1 100</p>
                        <p class="head__info__desc">НОВЫХ предложений ЗА МЕСЯЦ</p>
                    </div>
                    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="head__info head__info--center head__info-crediting">
                    <div>
                        <p class="head__info__count" data-value="156">156</p>
                        <p class="head__info__desc">СТРАХОВЫХ КОМПАНИЙ</p>
                    </div>
                    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="22" cy="22" r="22" fill="#03A9F4" />
                        <g clip-path="url(#clip0)">
                            <path d="M31.1284 29.2686H13.8635C13.3865 29.2686 13 29.655 13 30.1324C13 30.609 13.3865 30.9955 13.8635 30.9955H31.128C31.6051 30.9955 31.9915 30.609 31.9915 30.1324C31.9911 29.655 31.6046 29.2686 31.1284 29.2686Z"
                                fill="#EDF5FA" />
                            <path d="M14.9416 27.0239C14.4646 27.0239 14.0781 27.4103 14.0781 27.8874C14.0781 28.3644 14.4646 28.7512 14.9416 28.7512H30.0483C30.5253 28.7512 30.9118 28.3644 30.9118 27.8874C30.9118 27.4103 30.5253 27.0239 30.0483 27.0239H29.8328V19.2543H30.0483C30.2872 19.2543 30.4796 19.061 30.4796 18.8229C30.4796 18.5848 30.2864 18.3916 30.0483 18.3916H14.9416C14.7031 18.3916 14.5103 18.5848 14.5103 18.8229C14.5103 19.061 14.7035 19.2543 14.9416 19.2543H15.1575V27.0235H14.9416V27.0239ZM28.1059 19.2543V27.0235H25.5163V19.2543H28.1059ZM23.7893 19.2543V27.0235H21.1997V19.2543H23.7893ZM16.8836 19.2543H19.4732V27.0235H16.8836V19.2543Z"
                                fill="#EDF5FA" />
                            <path d="M13.8635 17.6154H31.1281C31.1309 17.6154 31.1341 17.6154 31.1365 17.6154C31.614 17.6154 32 17.2289 32 16.7519C32 16.3727 31.7559 16.0514 31.4167 15.9349L22.8507 12.0804C22.6255 11.9794 22.368 11.9794 22.1425 12.0804L13.5094 15.9648C13.1379 16.1322 12.9337 16.5356 13.0194 16.9334C13.1047 17.3312 13.4564 17.6154 13.8635 17.6154Z" fill="#EDF5FA" />
                        </g>
                        <defs>
                            <clipPath id="clip0">
                ...
                <div class="greetings-background-wrap notice-board-greetings-bg">
                    <img src="img/png/insurance-girl.png" alt="">
                </div>
                ...
                <div class="main__search">
                    <form action="" class="main__search__form">
                        <div class="select-wrap main__search__category-wrap">
                            ...
                            <ul class="select__body">
                                <li class="select-body-wrap">
                                    <ul>
                                        <li class="select-item">Ubezpieczenie samochodu</li>
                                        <li class="select-item">Ubezpieczenie podróżne</li>
                                        <li class="select-item">Ubezpieczenie nieruchomości</li>
                                        <li class="select-item">Ubezpieczenie na życie</li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        ...
                        <input class="main__search__input" type="text" placeholder="ЗАПРОС (НАПРИМЕР: СТРАХОВАНИЕ АВТО)">
        ...
        <div class="container container-table-cred">
            <div class="vacancy__head">
                <img class="vacancy__head--bg vacancy__head--bg-insurnes" src="/img/svg/insurnes-svg-bg.svg" alt="insurnes">
                <div class="vacancy__head--info">
                    ...
                    <a href="#" class="btn-add add-new-notice">
                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <section class="faq finance-open finance-open-transfer">
            <div class="finance-open__left-part">
                <a href="#">
                    <div class="finance-open__lp-item">
                        <div class="finance-open__img-block"><img src="img/png/crediting-1.png" class="finance-open__img-b" alt=""></div>
                        <div class="finance-open__text-block">
                            <p class="finance-open__tb-title">Alior bank - kredyt konsolidacyjny</p>
                            <ul class="finance-open__tb-ul">
                                <li class="finance-open__tb-list finance-open__normal-font">Mozliwosc wnioskowania o dodatkowa gotowke</li>
                                <li class="finance-open__tb-list finance-open__normal-font">Kredyt z ubezpieczenien na zycie
                                </li>
                                <li class="finance-open__tb-list finance-open__normal-font">Okres kredytowania nawet do 10 lat</li>
                                <li class="finance-open__tb-list finance-open__normal-font">RRSO 10,64%</li>
                            </ul>
                        </div>
                        <div class="finance-open__sticer-cont-rabat finance-open__sticer-cont">
                            <div class="finance-open__sticker">
                                Rabat
                            </div>
                        </div>
                    </div>
                ...
                <a href="">
                    <div class="finance-open__bunner">
                        <img src="img/png/crediting-bunner.png" alt="" class="finance-open__bunner-img">
                        <div class="finance-open__sticer-cont-rabat finance-open__sticer-cont">
                            <div class="finance-open__sticker">
                                Rabat
                            </div>
                ...
                <a href="">
                    <div class="finance-open__bunner">
                        <img src="img/png/crediting-bunner.png" alt="" class="finance-open__bunner-img">
                        <div class="finance-open__sticer-cont-promocja finance-open__sticer-cont">
                            <div class="finance-open__sticker">
                                Promocja
                            </div>
                        </div>
                ...
                <a href="">
                    <div class="finance-open__bunner">
                        <img src="img/png/crediting-bunner.png" alt="" class="finance-open__bunner-img">
                        <div class="finance-open__sticer-cont-podarunkowa finance-open__sticer-cont">
                            <div class="finance-open__sticker">
                                Karta podarunkowa
                            </div>
                        </div>
                ...
                <a href="">
                    <div class="finance-open__bunner">
                        <img src="img/png/crediting-bunner.png" alt="" class="finance-open__bunner-img">
                        <div class="finance-open__sticer-cont finance-open__sticer-cont-nic">
                            <div class="finance-open__sticker">
                                Nic z tego
                            </div>
                        </div>
                ...
                <a href="#">
                    <div class="finance-open__lp-item">
                        <div class="finance-open__img-block"><img src="img/svg/crediting-3.svg" class="finance-open__img-b"
                                                                  alt=""></div>
                        <div class="finance-open__text-block">
                            <p class="finance-open__tb-title">Santander - kredyt samochodowy</p>
                            <ul class="finance-open__tb-ul">
                                <li class="finance-open__tb-list  last-child-finance"> Wlasne auto</li>
                                <li class="finance-open__tb-list finance-open__normal-font last-child-finance"> za tak nie
                                    wiele</li>
                                <li class="finance-open__tb-list finance-open__normal-font last-child-finance"> juz od 2,99%
                                    &nbsp; &nbsp; RRSO 9,12% </li>
                            </ul>
                        </div>
                    </div>
                ...
                <a href="#">
                    <div class="finance-open__lp-item">
                        <div class="finance-open__img-block"><img src="img/png/crediting-2.png" class="finance-open__img-b"
                                                                  alt=""></div>
                        <div class="finance-open__text-block">
                            <p class="finance-open__tb-title">Expander - kredyt hipoteczny</p>
                            <ul class="finance-open__tb-ul">
                                <li class="finance-open__tb-list finance-open__normal-font last-child-finance"> Prownywarka
                                    kredytow</li>
                                <li class="finance-open__tb-list finance-open__normal-font last-child-finance"> Aktualne
                                    oferty 12 bankow w jednym miejscu</li>
                            </ul>
                        </div>
                        <div class="finance-open__sticer-cont-promocja finance-open__sticer-cont">
                            <div class="finance-open__sticker">
                ...
                <a href="#">
                    <div class="finance-open__lp-item">
                        <div class="finance-open__img-block"><img src="img/png/crediting-1.png" class="finance-open__img-b"
                                                                  alt=""></div>
                        <div class="finance-open__text-block">
                            <p class="finance-open__tb-title">Alior bank - kredyt konsolidacyjny</p>
                            <ul class="finance-open__tb-ul">
                                <li class="finance-open__tb-list finance-open__normal-font">Mozliwosc wnioskowania o
                                    dodatkowa gotowke</li>
                                <li class="finance-open__tb-list finance-open__normal-font">Kredyt z ubezpieczenien na zycie
                                </li>
                                <li class="finance-open__tb-list finance-open__normal-font">Okres kredytowania nawet do 10
                                    lat</li>
                                <li class="finance-open__tb-list finance-open__normal-font">RRSO 10,64%</li>
                            </ul>
                        </div>
            ...
            <div class="finance-open__right-part">
                <div class="finance-open__time">
                    Текущее время: &nbsp;19.10.2020. 09:56:00
                </div>
                <div class="finance-open__currency-block">
                    <div class="finance-open__course-part">
                        <div class="finance-open__course first-column">Курс валют</div>
                        <div class="finance-open__number first-column">1 USD =</div>
                        <span class="select__icon-finance "></span>
                    </div>
                    <div class="finance-open__course-part">
                        <div class="finance-open__course ">Euro</div>
                        <div class="finance-open__number ">0.855</div>
                    </div>
                    <div class="finance-open__course-part">
                        <div class="finance-open__course ">Polish Zloty</div>
                        <div class="finance-open__number ">3.89</div>
                    </div>
                    <div class="finance-open__course-part">
                        <div class="finance-open__course ">Ukraine Hryvnia</div>
                        <div class="finance-open__number ">28.355</div>
                    </div>
                    <div class="finance-open__course-part">
                        <div class="finance-open__course ">Russian Rouble</div>
                        <div class="finance-open__number ">78.116
                        </div>
                    </div>
                    <div class="finance-open__course-part">
                        <div class="finance-open__course ">Moldovan Leu </div>
                        <div class="finance-open__number ">16.954
                        </div>
                    </div>
                    <div class="finance-open__course-part">
                        <div class="finance-open__course ">Romanian New</div>
                        <div class="finance-open__number ">4.168</div>
                    </div>
                    <div class="finance-open__course-part">
                        <div class="finance-open__course ">Czech Koruna</div>
                        <div class="finance-open__number ">23.369</div>
                    </div>
                </div>
            </div>
        </section>

        <section class="faq pag-section">
            <div class="pagination finance-pag">
                <ul>
                    <li class="nav-btn">предыдущая</li>
                    <li class="active"><a href="#">1</a></li>
                    <li><a href="property-two-page.html#product">2</a></li>
                    <li><a href="property-three-page.html#product">3</a></li>
                    <li><a href="#">4</a></li>
                    <li><span>...</span></li>
                    <li><a href="#">12</a></li>
                    <li class="nav-btn"><a href="property-two-page.html#product">следующая</a></li>
                </ul>
                <a class="new-ads__see-all" id="seeMore">ПРОСМОТРЕТЬ ЕЩЕ</a>
            </div>
        </section>
