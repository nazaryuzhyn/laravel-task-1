...
@section('title')PobytOK - Недвижимость@endsection
@section('style')
    @parent
...
@section('content')
    <main class="page-main">
        <section class="property-greetings">
            <div class="container">
                ...
                <div class="vacancy__header--ttl">
                    <h1>Недвижимость</h1>
                    <p>Покупай, продавай ИЛИ бери в аренду</p>
                </div>
                ...
                <div class="head__info head__info--bottom">
                    ...
                    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path  d="M26.1459 23H18.3541C15.9534 23 14 24.9534 14 27.3541V30.5625C14 30.942 14.308 31.25 14.6875 31.25H29.8125C30.192 31.25 30.5 30.942 30.5 30.5625V27.3541C30.5 24.9534 28.5466 23 26.1459 23Z"
                            fill="#F2F2F2"></path>
                    </svg>
                </div>
                ...
                <div class="greetings-background-wrap">
                    <img src="{{ asset('/img/png/property.png') }}" alt="" class="vacancy__background">
                </div>
                            ...
                            <ul class="select__body">
                                <li class="select-body-wrap">
                                    <ul>
                                        ...
                                        <li class="select-item">Квартиры</li>
                                        <li class="select-item">Комнаты</li>
                                        <li class="select-item">Сад</li>
                                        <li class="select-item">Дома</li>
                                        <li class="select-item">Гаражи / стоянки</li>
                                        <li class="select-item">Склады/li>
                                        <li class="select-item">Участки</li>
                                        <li class="select-item">Ночлеги</li>
                                        <li class="select-item">Другие объявления</li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="offers-block__filter">
                    <form action="#" method="#">
                        <div class="select-wrap">
                            <label for="mobile-offer-origin" class="field-label">Предложение от</label>
                            <div class="select__header">
                                <input type="text" class="select" id="mobile-offer-origin" value="Все" readonly>
                                <span class="select__icon"></span>
                            </div>
                            <ul class="select__body">
                                <li class="select-item">Все</li>
                                <li class="select-item">Агентство недвижимости</li>
                                <li class="select-item">Физическое лицо</li>
                            </ul>
                        </div>
                        <div class="select-wrap">
                            <label for="mobile-offer-type" class="field-label">Тип предложения</label>
                            <div class="select__header">
                            ...
                            <ul class="select__body">
                                <li class="select-item">Все</li>
                                <li class="select-item">Аренда</li>
                                <li class="select-item">Продажа</li>
                        ...
                        <div>
                            ...
                            <div class="range-wrap middle">
                                <div class="range-slider">

                                    <input type="number" class="offers-block__filter-number input-with-keypress-0"
                                           value="0"> -
                                    <input type="number" class="offers-block__filter-number input-with-keypress-1"
                                           value="10000">
                        ...
                        <div>
                            <label class="field-label">Площадь, м2</label>
                            <div>
                                <input type="number" class="offers-block__filter-number" placeholder="От"> - <input
                                    type="number"
                                    class="offers-block__filter-number"
                                    placeholder="До">
                            </div>
                        </div>
                        <div class="select-wrap">
                            <label for="mobile-level" class="field-label">Этаж</label>
                            <div class="select__header">
                                <input type="text" class="select" id="mobile-level" value="Все" readonly>
                                <span class="select__icon"></span>
                            </div>
                            <ul class="select__body">
                                <li class="select-item">Все</li>
                                <li class="select-item">Подвал</li>
                                <li class="select-item">Партер</li>
                                ...
                                <li class="select-item">Выше 10</li>
                                <li class="select-item">Чердак</li>
                            </ul>
                        </div>
                        <div class="select-wrap">
                            <label for="mobile-rooms" class="field-label">Количество комнат</label>
                            <div class="select__header">
                                <input type="text" class="select" id="mobile-rooms" value="Все" readonly>
                                <span class="select__icon"></span>
                            </div>
                            <ul class="select__body">
                                <li class="select-item">Все</li>
                                <li class="select-item">Кавалерка</li>
                                <li class="select-item">Комната</li>
                                <li class="select-item">2 комнаты</li>
                                <li class="select-item">3 комнаты</li>
                                <li class="select-item">4 и больше</li>
                            </ul>
                        </div>
                        <div class="select-wrap">
                            <label for="mobile-furniture" class="field-label">Мебель</label>
                            <div class="select__header">
                                <input type="text" class="select" id="mobile-furniture" value="Все" readonly>
                                <span class="select__icon"></span>
                            </div>
                            <ul class="select__body">
                                <li class="select-item">Все</li>
                                ...
                                <li class="select-item">Частично</li>
                            </ul>
                        </div>
                        <div class="select-wrap">
                            <label for="mobile-animals" class="field-label">Домашние животные</label>
                            <div class="select__header">
                                <input type="text" class="select" id="mobile-animals" value="Все" readonly>
                                <span class="select__icon"></span>
                            </div>
                            <ul class="select__body">
                                <li class="select-item">Все</li>
                        ...
                        <div class="select-wrap">
                            <label for="mobile-children" class="field-label">Дети</label>
                            <div class="select__header">
                                <input type="text" class="select" id="mobile-children" value="Все" readonly>
                                <span class="select__icon"></span>
                            </div>
                            <ul class="select__body">
                                <li class="select-item">Все</li>
                        ...
                        <div class="select-wrap">
                            <label for="mobile-foreigner" class="field-label">Иностранцы</label>
                            <div class="select__header">
                                <input type="text" class="select" id="mobile-foreigner" value="Все" readonly>
                                <span class="select__icon"></span>
                            </div>
                            <ul class="select__body">
                                <li class="select-item">Все</li>
                        ...
                        <div class="select-wrap">
                            <label for="mobile-smokers" class="field-label">Курильщики</label>
                            <div class="select__header">
                                <input type="text" class="select" id="mobile-smokers" value="Все" readonly>
                                <span class="select__icon"></span>
                            </div>
                            <ul class="select__body">
                                <li class="select-item">Все</li>
        ...
        <section class="offers-block container vacancy-container offers-block-property">
            <h2 class="visually-hidden">Недвижимость</h2>
            <div class="offers-block__filter">

                <form action="#" method="#">
                    <div class="select-wrap">
                        <label for="offer-origin" class="field-label">Предложение от</label>
                        <div class="select__header">
                            <input type="text" class="select" id="offer-origin" value="Все" readonly>
                            <span class="select__icon"></span>
                        </div>
                        <ul class="select__body">
                            <li class="select-item">Все</li>
                    ...
                    <div class="select-wrap">
                        <label for="offer-type" class="field-label">Тип предложения</label>
                        <div class="select__header">
                    ...
                    <div>
                        ...
                        <div class="range-wrap middle">
                            <div class="range-slider">
                                ...
                                <input type="number" class="offers-block__filter-number input-with-keypress-0-desc"
                                       value="0"> -
                                <input type="number" class="offers-block__filter-number input-with-keypress-1-desc"
                                       value="10000">

                                <div class="style-2 wrapper m-b-50 p-l-r">

                                    <div class="slider-keypress-desc m-b-20 "></div>
                                </div>
                    ...
                    <div class="select-wrap">
                        <label for="level" class="field-label">Этаж</label>
                        <div class="select__header">
                            <input type="text" class="select" id="level" value="Все" readonly>
                            <span class="select__icon"></span>
                        </div>
                        <ul class="select__body">
                            <li class="select-body-wrap">
                    ...
                    <div class="select-wrap">
                        ...
                        <div class="select__header">
                            <input type="text" class="select" id="rooms" value="Все" readonly>
                            <span class="select__icon"></span>
                        </div>
                        <ul class="select__body">
                            <li class="select-item">Все</li>
                    ...
                    <div class="select-wrap">
                        <label for="furniture" class="field-label">Мебель</label>
                        <div class="select__header">
                            <input type="text" class="select" id="furniture" value="Все" readonly>
                            <span class="select__icon"></span>
                        </div>
                        <ul class="select__body">
                            <li class="select-item">Все</li>
                    ...
                    <div class="select-wrap">
                        <label for="animals" class="field-label">Домашние животные</label>
                        <div class="select__header">
                            <input type="text" class="select" id="animals" value="Все" readonly>
                            <span class="select__icon"></span>
                        </div>
                        <ul class="select__body">
                            <li class="select-item">Все</li>
                    ...
                    <div class="select-wrap">
                        <label for="children" class="field-label">Дети</label>
                        <div class="select__header">
                            <input type="text" class="select" id="children" value="Все" readonly>
                            <span class="select__icon"></span>
                        </div>
                        <ul class="select__body">
                            <li class="select-item">Все</li>
                    ...
                    <div class="select-wrap">
                        <label for="foreigner" class="field-label">Иностранцы</label>
                        <div class="select__header">
                            <input type="text" class="select" id="foreigner" value="Все" readonly>
                            <span class="select__icon"></span>
                        </div>
                        <ul class="select__body">
                            <li class="select-item">Все</li>
                    ...
                    <div class="select-wrap">
                        <label for="smokers" class="field-label">Курильщики</label>
                        <div class="select__header">
                            <input type="text" class="select" id="smokers" value="Все" readonly>
                            <span class="select__icon"></span>
                        </div>
                        <ul class="select__body">
                            <li class="select-item">Все</li>
            ...
            <div class="offers-block__offers">
                <div class="vacancy__filter">
                    ...
                    <div class="vacancy__resume">
                        <span class="vacancy__resume--text vacancy__resume--text--left active">Недвижимость</span>
                        <div class="vacancy__resume--body">
                            <input id="resume" type="checkbox">
                            <label for="resume"></label>
                        </div>
                        <span class="vacancy__resume--text vacancy__resume--text--right">Поиск жилья</span>
                    </div>
                    ...
                    <li class="offers-block__item new-ads__item">
                        <article class="new-ads__ad">
                            <div class="new-ads__logo-wrap">
                                <img src="img/jpg/home.jpg" alt="Firm logo">
                            ...
                            <div class="new-ads__info-block">
                                <div class="new-ads__title-block">
                                    <a class="new-ads__ad-link" href="#">
                                        <h3 class="new-ads__item-title">Piękny LOFT 42M</h3>
                                    </a>
                                    <span class="new-ads__company-name">ЧАСТНОЕ ЛИЦО</span>
                                    <div class="news-descr">
                                        <p>
                                            Совокупность инструментов для решения типичных сложностей, возникающих с рядом
                                            <br> направлений
                                            жизнедеятельности иностранца в Польше. Поиск работы, недвижимости, коммуникация,
                                            легализация,
...
@section('script')
    ...
    <script src="/js/property-onload.js"></script>
    <script src="/js/nouislider.js"></script>
    <script src="/js/nouislider-config.js"></script>
@endsection
