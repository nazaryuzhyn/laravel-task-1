...
@section('title')PobytOK - Доска объявлений@endsection

@section('content')
    <main>
        <section class="notice-greetings">
            <div class="container">
                <div>
                ...
                <div class="head__info head__info--bottom">
                    ...
                    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M26.8338 16.5834C26.8338 19.1147 24.7817 21.1666 22.2504 21.1666C19.7191 21.1666 17.667 19.1147 17.667 16.5834C17.667 14.0521 19.7191 12 22.2504 12C24.7817 12 26.8338 14.0521 26.8338 16.5834Z" fill="#F2F2F2"></path>
                        <path d="M26.1459 23H18.3541C15.9534 23 14 24.9534 14 27.3541V30.5625C14 30.942 14.308 31.25 14.6875 31.25H29.8125C30.192 31.25 30.5 30.942 30.5 30.5625V27.3541C30.5 24.9534 28.5466 23 26.1459 23Z" fill="#F2F2F2"></path>
                    </svg>
                </div>
                <div class="head__info head__info--center">
                    <div>
                        <p class="head__info__count" data-value="12303">12 303</p>
                ...
                <div class="greetings-background-wrap notice-board-greetings-bg">
                    <img src="/img/png/notice-board-greetings.png" alt="">
                </div>
                <div class="main__search">
                    <form action="" class="main__search__form">
                        <div class="select-wrap main__search__category-wrap">
                            <div class="select__header">
                                <input type="text" class="select main__search__category-input" readonly=""
                            ...
                            <ul class="select__body">
                                <li class="select-body-wrap">
                                    <ul>
                                        ...
                                        <li class="select-item">Транспорт</li>
                                        <li class="select-item">Дом и сад</li>
                                        <li class="select-item">Электроника</li>
                                        <li class="select-item">Мода и стиль</li>
                                        <li class="select-item">Сельское хозяйство</li>
                                        <li class="select-item">Животные</li>
                                        <li class="select-item">Для детей</li>
                                        <li class="select-item">Спорт и хобби</li>
                                        <li class="select-item">Музыка</li>
                                        <li class="select-item">Услуги и фирмы</li>
                                        <li class="select-item">Свадьба</li>
                                        <li class="select-item">Отдам даром</li>
                                        <li class="select-item">Обмен</li>
                        ...
                        <div class="select-wrap filter__all-regions-desktop-wrap">
                            <div class="select__header">
                                <svg class="main__search__point" width="10" height="15" viewBox="0 0 10 15" fill="none"
                                ...
                                <input type="text" class="select main__search__city-input" readonly=""
                        ...
                        <div class="select-wrap filter__all-regions-tablet-wrap">
                            <div class="select__header">
                                <svg class="tablet-point" width="13" height="19" viewBox="0 0 13 19" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M6.5 0C2.91597 0 0 2.84121 0 6.33335C0 7.38169 0.269 8.42112 0.780379 9.34306L6.14455 18.7959C6.21596 18.9219 6.35204 19 6.5 19C6.64796 19 6.78405 18.9219 6.85546 18.7959L12.2216 9.33995C12.731 8.42112 13 7.38165 13 6.33331C13 2.84121 10.084 0 6.5 0ZM6.5 9.5C4.70798 9.5 3.25002 8.07942 3.25002 6.33335C3.25002 4.58728 4.70798 3.16669 6.5 3.16669C8.29202 3.16669 9.74998 4.58728 9.74998 6.33335C9.74998 8.07942 8.29202 9.5 6.5 9.5Z"
                                        fill="#464646" />
                                </svg>
                        ...
                        <div class="select-wrap filter__city-input-wrap">
                            <div class="select__header cities-tablet-input-wrap">
                                ...
                                <input class="select filter__city-input" readonly="" type="text" autocomplete="off"
                                       placeholder="Город" name="mobile_city" value="">
                                <span class="select__icon"></span>
                            </div>
                        ...
                        <input class="main__search__input" type="text" placeholder="Запрос(например: смартфон, мебель)">
                        <button type="submit" class="main__search__search-submit">
                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M13.9207 13.1547L10.1443 9.37832C10.8605 8.49404 11.2917 7.36984 11.2917 6.14585C11.2917 3.30845 8.98324 1 6.14583 1C3.30842 1 1 3.30845 1 6.14585C1 8.98326 3.30845 11.2917 6.14586 11.2917C7.36984 11.2917 8.49404 10.8605 9.37832 10.1443L13.1547 13.9207C13.2605 14.0264 13.432 14.0264 13.5378 13.9207L13.9207 13.5377C14.0264 13.432 14.0264 13.2605 13.9207 13.1547ZM6.14586 10.2084C3.90566 10.2084 2.08334 8.38605 2.08334 6.14585C2.08334 3.90566 3.90566 2.08334 6.14586 2.08334C8.38605 2.08334 10.2084 3.90566 10.2084 6.14585C10.2084 8.38605 8.38605 10.2084 6.14586 10.2084Z" fill="white" stroke="white"></path>
                            </svg>
                            ИСКАТЬ
                        </button>
                    </form>
        ...
        <div class="container">
            <div class="vacancy__head">
                <img class="vacancy__head--bg" src="img/svg/notice-board.svg" alt="">
        ...
        <section class="notice-categories container" id="category">
            <h2 class="notice-title">Категории объявлений</h2>
            <ul class="categories-list">
                <li class="categories-item car-item">
                    <button class="categories-btn">
                        <div class="categories-icon-wrap">
                            <img src="/img/svg/notice-transport.svg" alt="Transport" class="categories__link-icon">
                        </div>
                        <h3 class="services__title">ТРАНСПОРТ</h3>
                    </button>
                    <div class="categories-underlist-wrap hidden">
                        <a href="#" class="categories-underlist-link categories-underlist-main-link">
						<span>Просмотреть все обьявления в разделе <span class="categories-underlist-text">ТРАНСПОРТ</span></span>
                        </a>
                        <ul class="categories-underlist">
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Легковые автомобили</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Мотоциклы и скутеры</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Фургоны и грузовики</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Прицепы</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Автозапчасти</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Запчасти для мотоциклов</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Шины и диски</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Аудио оборудование</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Сельское хозяйство</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Разное - моторизация</a>
                            </li>
                        </ul>

                    </div>
                </li>
                <li class="categories-item prop-item">
                    <button class="categories-btn">
                        <div class="categories-icon-wrap">
                            <img src="/img/svg/notice-property.svg" alt="Property" class="categories__link-icon">
                        </div>
                        <h3 class="services__title">Дом и сад</h3>
                    </button>
                    <div class="categories-underlist-wrap hidden">
                        <a href="#" class="categories-underlist-link categories-underlist-main-link">
						    <span>Просмотреть все обьявления в разделе <span class="categories-underlist-text">Дом исад</span></span>
                        </a>
                        <ul class="categories-underlist">
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Мебель</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Бытовая техника</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Здоровье</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Сад</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Внутренняя отделка</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Инструменты</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Стройматериалы</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Отопление</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Разное - дом и сад</a>
                            </li>
                            <li class="categories-underlist-item empty-category"></li>
                        </ul>
                    </div>
                </li>
                <li class="categories-item electronic-item">
                    <button class="categories-btn">
                        <div class="categories-icon-wrap">
                            <img src="/img/svg/notice-electronic.svg" alt="Electronic" class="categories__link-icon">
                        </div>
                        <h3 class="services__title">Электроника</h3>
                    </button>
                    <div class="categories-underlist-wrap hidden">
                        <a href="#" class="categories-underlist-link categories-underlist-main-link">
						    <span>Просмотреть все обьявления в разделе <span class="categories-underlist-text">Электроника</span></span>
                        </a>
                        <ul class="categories-underlist">
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Мобильные телефоны</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Аксессуары</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Планшеты</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Телевизоры</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Игровые приставки</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Видеооборудование</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Фотография</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Аудиооборудование</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Разное - электроника</a>
                            </li>
                            <li class="categories-underlist-item empty-category"></li>
                        </ul>
                ...
                <li class="categories-item style-item">
                    <button class="categories-btn">
                        <div class="categories-icon-wrap">
                            <img src="/img/svg/notice-style.svg" alt="Style" class="categories__link-icon">
                        </div>
                        <h3 class="services__title">Мода и стиль</h3>
                    </button>
                    <div class="categories-underlist-wrap hidden">
                        <a href="#" class="categories-underlist-link categories-underlist-main-link">
						    <span>Просмотреть все обьявления в разделе <span class="categories-underlist-text">Мода и
                                    стиль</span></span>
                        </a>
                        <ul class="categories-underlist">
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Одежда</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Обувь</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Бельё</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Одежда для беременных</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Аксессуары</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Бижутерия</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Сумки</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Часы</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Косметика и парфюмы</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Разное - мода и стиль</a>
                            </li>
                        </ul>

                    </div>
                </li>
                <li class="categories-item aggricult-item">
                    <button class="categories-btn">
                        <div class="categories-icon-wrap">
                            <img src="/img/svg/notice-aggricult.svg" alt="Aggricult" class="categories__link-icon">
                        </div>
                        <h3 class="services__title">Сельское хозяйство</h3>
                    </button>
                    <div class="categories-underlist-wrap hidden">
                        <a href="#" class="categories-underlist-link categories-underlist-main-link">
						    <span>Просмотреть все обьявления в разделе <span class="categories-underlist-text">Сельское
                                хозяйство</span></span>
                        </a>
                        <ul class="categories-underlist">
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Тракторы</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Сельскохозяйственная техника</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Трейлеры / прицепы</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Запчасти для сельхозтехники</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Шины</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Сельскохозяйственные продукты</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Обмен животными</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Рынок</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Разное - сельское хозяйство</a>
                            </li>
                            <li class="categories-underlist-item empty-category"></li>
                        </ul>
                ...
                <li class="categories-item animal-item">
                    <button class="categories-btn">
                        <div class="categories-icon-wrap">
                            <img src="/img/svg/notice-animals.svg" alt="Animals" class="categories__link-icon">
                        </div>

                        <h3 class="services__title">Животные</h3>
                    </button>
                    <div class="categories-underlist-wrap hidden">
                        <a href="#" class="categories-underlist-link categories-underlist-main-link">
						<span>Просмотреть все обьявления в разделе <span
                                class="categories-underlist-text">Животные</span></span>
                        </a>
                        <ul class="categories-underlist">
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Собаки</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Коты</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Птицы</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Грызуны</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Кони</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Рыбоводство</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Аксессуары</a>
                            </li>
                            ...
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Пропавшие / найденные</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Разное - животные</a>
                            </li>
                        </ul>

                    </div>
                </li>
                <li class="categories-item child-item">
                    <button class="categories-btn">
                        <div class="categories-icon-wrap">
                            <img src="/img/svg/notice-kids.svg" alt="Kids" class="categories__link-icon">
                        </div>
                        <h3 class="services__title">Для детей</h3>
                    </button>
                    <div class="categories-underlist-wrap hidden">
                        <a href="#" class="categories-underlist-link categories-underlist-main-link">
						<span>Просмотреть все обьявления в разделе <span class="categories-underlist-text">Для
								детей</span></span>
                        </a>
                        <ul class="categories-underlist">
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Игрушки</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Коляски</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Аксессуары</a>
                            </li>
                            ...
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Разное - для детей</a>
                            </li>
                        </ul>

                    </div>
                </li>
                <li class="categories-item sport-item">
                    <button class="categories-btn">
                        <div class="categories-icon-wrap">
                            <img src="/img/svg/notice-sport.svg" alt="Sport" class="categories__link-icon">
                        </div>

                        <h3 class="services__title">Спорт и хобби</h3>
                    </button>
                    <div class="categories-underlist-wrap hidden">
                        <a href="#" class="categories-underlist-link categories-underlist-main-link">
						<span>Просмотреть все обьявления в разделе <span class="categories-underlist-text">Спорт и
								хобби</span></span>
                        </a>
                        <ul class="categories-underlist">
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Билеты</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Коллекции</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Милитари</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Велосипеды</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Фитнесс</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Зимние виды спорта</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Ловля рыбы</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Туризм</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Сообщество</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Водный спорт</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Спортивная одежда</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Спортивная обувь</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Верховая езда</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Катание на коньках</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Разное - спорт и хобби</a>
                            </li>
                        </ul>

                    </div>
                </li>
                <li class="categories-item music-item">
                    <button class="categories-btn">
                        <div class="categories-icon-wrap">
                            <img src="/img/svg/notice-music.svg" alt="Music" class="categories__link-icon">
                        </div>
                        <h3 class="services__title">Музыка</h3>
                    </button>
                    <div class="categories-underlist-wrap hidden">
                        <a href="#" class="categories-underlist-link categories-underlist-main-link">
						<span>Просмотреть все обьявления в разделе <span
                                class="categories-underlist-text">Музыка</span></span>
                        </a>
                        <ul class="categories-underlist">
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Книги</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Музыка</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Фильмы</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Инструменты</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Музыкальное оборудование</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Языковые материалы</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Разное - музыка</a>
                            </li>
                        </ul>

                    </div>
                </li>
                <li class="categories-item firm-item">
                    <button class="categories-btn">
                        <div class="categories-icon-wrap">
                            <img src="/img/svg/notice-office.svg" alt="Office" class="categories__link-icon">
                        </div>

                        <h3 class="services__title">Услуги и фирмы</h3>
                    </button>
                    <div class="categories-underlist-wrap hidden">
                        <a href="#" class="categories-underlist-link categories-underlist-main-link">
						<span>Просмотреть все обьявления в разделе <span class="categories-underlist-text">Услуги и
								фирмы</span></span>
                        </a>
                        <ul class="categories-underlist">
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Услуги</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Деловое сотрудничество</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Оборудование для бизнеса</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Строительство и ремонт</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Частные уроки</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Курсы и семинары</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Мебель на заказ</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Музыканты</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Ведение мероприятий</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Сервис бытовой техники</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Уборка</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Услуги для животных</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Финансовые услуги</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">IT услуги</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Переводы</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Косметические услуги</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Автомобильные услуги</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Садовые услуги</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Рекламные услуги</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Транспортные услуги</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Медицинские услуги</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Ремонтные услуги</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Разное - услуги и фирмы</a>
                            </li>
                        </ul>

                    </div>
                </li>
                <li class="categories-item marriage-item">
                    <button class="categories-btn">
                        <div class="categories-icon-wrap">
                            <img src="/img/svg/notice-marriage.svg" alt="Marriage" class="categories__link-icon">
                        </div>
                    ...
                    <div class="categories-underlist-wrap hidden">
                        <a href="#" class="categories-underlist-link categories-underlist-main-link">
						<span>Просмотреть все обьявления в разделе <span
                                class="categories-underlist-text">Свадьба</span></span>
                        </a>
                        <ul class="categories-underlist marriage-wrap">
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Свадебная мода</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Свадебные услуги</a>
                            </li>
                            <li class="categories-underlist-item">
                                <a href="#" class="categories-underlist-link">Аксессуары</a>
                            </li>
                ...
                <li class="categories-item">
                    <a href="#" class="categories-link-btn">
                        <div class="categories-icon-wrap">
                            <img src="/img/svg/notice-free.svg" alt="Free" class="categories__link-icon">
                        </div>

                        <h3 class="services__title">Отдам даром</h3>
                    </a>
                </li>
                <li class="categories-item">
                    <a href="#" class="categories-link-btn">
                        <div class="categories-icon-wrap">
                            <img src="/img/svg/notice-change.svg" alt="Change" class="categories__link-icon">
                        </div>
                        <h3 class="services__title">ОБМЕН</h3>
                    </a>
                </li>
                <li class="categories-item">
                    <a href="#" class="categories-link-btn">
                        <div class="categories-icon-wrap">
                            <img src="/img/svg/notice-other.svg" alt="Other" class="categories__link-icon">
                        </div>
                        <h3 class="services__title">ДРУГОЕ</h3>
                    </a>
                </li>
            </ul>
        </section>

        <section class="new-ads notice-new-ads-wrap">

            <div class="new-ads__ads-wrap">
                <div class="container">
                    ...
                    <div class="new-ads__active-wrap new-ads__wrap new-ads__work-wrap">
                                    ...
                                    <div class="new-ads__logo-wrap">
                                        ...
                                        <button class="new-ads__like-btn">
                                            <svg width="26" height="23" viewBox="0 0 26 23" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M11.75 4.41115L12.5454 5.4551L13.3409 4.41115C13.7773 3.83829 14.5234 2.9623 15.4656 2.23775C16.4163 1.50671 17.4746 1 18.5568 1C21.4961 1 24.0909 3.74636 24.0909 7.38353C24.0909 9.0183 23.5479 10.562 22.5802 11.747L22.5172 11.8242L22.5016 11.8537C22.4444 11.9157 22.3902 11.9685 22.3229 12.032L22.3228 12.032L22.3127 12.0417L22.2096 12.1418L22.2043 12.147L22.1991 12.1522L12.5452 21.8026L3.25817 12.5348L3.21378 12.458L3.101 12.3545C1.77698 11.1391 1 9.34242 1 7.38353C1 3.74637 3.59485 1 6.53406 1C7.61629 1 8.67456 1.50671 9.62525 2.23775C10.5675 2.9623 11.3135 3.83829 11.75 4.41115Z"
                                                    stroke="#DFE5EC" stroke-width="2" />
                                            </svg>
                                        </button>
                                    </div>
                        ...
                        <a href="#category" class="new-ads__see-all">ВЫБРАТЬ КАТЕГОРИЮ</a>
                    </div>
                </div>
            </div>
        </section>
...
@section('script')
    ...
    <script src="/js/notice-onload.js"></script>
    <script src="/js/notice-categories.js"></script>
@endsection
